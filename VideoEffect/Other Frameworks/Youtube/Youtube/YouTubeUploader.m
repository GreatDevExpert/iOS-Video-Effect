...
- (id)init {
    if ((self = [super init])) {
        ...
        [[[self youTubeService] authorizer] setShouldAuthorizeAllRequests:YES];
    }
    return self;
}
...
- (void)uploadVideoFile:(NSString*)path {
    ...
    NSString *titleStr = self.mediaTitle;
    GDataMediaTitle *title = [GDataMediaTitle textConstructWithString:titleStr];
    
    
    NSString *descStr = self.mediaDescription;
...
- (void)runSignin:(NSString*)path {
    ...
    GTMOAuth2ViewControllerTouch *viewController = [[[GTMOAuth2ViewControllerTouch alloc ]initWithScope:scope
                                                                                      ...
                                                                                      completionHandler:completionHandler] autorelease];
